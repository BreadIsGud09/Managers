...
import { reportLovableError } from "../Shared/lovable-error-reporting";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Ứng dụng quản lý học sinh 3 lớp Piano, Múa, Vẽ: điểm danh, thời khóa biểu, học phí và nhắc nhở qua Telegram." },
